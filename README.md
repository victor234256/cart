...
🛒 Full Cart management with Redux Toolkit (add, remove, update)

🔔 Toast notifications via React Toastify

🔐 Simple authentication via localStorage

💳 After checkout, users are redirected to a dashboard
...
ShadCN/UI & Lucide Icons for design
